...
import com.free.user.util.AjaxJson;
import com.free.user.util.Ttime;
...
//		StpUtil.logoutByLoginId(10001);
	...
	public AjaxJson testRole() {
		...
		System.out.println("是否具有角色标识 user " + StpUtil.hasRole("com/free/user"));
		...
		StpUtil.checkRoleOr("admin", "com/free/user");

		System.out.println("在【admin、user】中必须全部拥有才不会抛出异常");
		StpUtil.checkRoleAnd("admin", "com/free/user");
